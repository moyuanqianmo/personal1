$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;pointer-events:none;">Happy Birthday</a>');
            $('.begin').fadeIn();
            return;
        }
    };
